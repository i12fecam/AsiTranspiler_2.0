...
public enum ErrorEnum {
    ...
    LOGICA_CONTROL_NO_EXHAUSTIVA(FATAL_ERROR,"La combinación de banderas definidas está mal formada (%s)."),
    PASO_COMPLEJO_NO_EXHAUSTIVO(FATAL_ERROR,"La combinación de banderas definidas esta mal formada (%s)."),
    ESPACIO_MEMORIA_SUPERADO(FATAL_ERROR,"La definición del programa (variables + llamadas a instrucciones) supera el máximo de espacio de memoria de la computadora."),
    VALOR_VARIABLE_NO_VALIDO(FATAL_ERROR,"El valor de la variables %s supera el tamaño máximo de la celda de memoria (16bits)."),
