...
public enum MicroInstruction {
    ...
    gpr_plus_acc_to_acc("GPR+ACC->ACC","GPR+ACC->GPR",5*Math.pow(2,15)),
    ...
    shl_f_acc_qr("SHL_F_A_Q","SHL_F_A_Q",20*Math.pow(2,15)),
    ...
    private MicroInstruction(String inputName, String outputName,double microProgramadoCode){
