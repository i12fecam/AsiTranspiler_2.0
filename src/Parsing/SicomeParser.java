...
public class SicomeParser extends Parser {
	...
	public static final int
		...
		T__24=25, T__25=26, T__26=27, T__27=28, T__28=29, T__29=30, FLAG=31, IDENTIFIER=32, 
		MICRO_INSTR=33, NUMBER=34, HEXNUMBER=35, DECNUMBER=36, LINE_COMMENT=37, 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, "FLAG", "IDENTIFIER", "MICRO_INSTR", 
			"NUMBER", "HEXNUMBER", "DECNUMBER", "LINE_COMMENT", "COMMENT", "NEWLINE", 
			"WS"
		};
	}
	...
	public final MicroStepContext microStep() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 4303880192L) != 0)) {
				{
				{
				setState(260);
