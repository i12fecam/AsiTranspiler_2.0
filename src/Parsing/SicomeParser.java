...
public class SicomeParser extends Parser {
	...
	public static final int
		...
		T__24=25, NUMBER=26, FLAG=27, IDENTIFIER=28, MICRO_INSTR=29, LINE_COMMENT=30, 
		COMMENT=31, NEWLINE=32, WS=33;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'BIF'", "'RET'", "'DISABLE'", "'@microinstruccion'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, "NUMBER", "FLAG", "IDENTIFIER", "MICRO_INSTR", "LINE_COMMENT", 
			"COMMENT", "NEWLINE", "WS"
		};
	}
